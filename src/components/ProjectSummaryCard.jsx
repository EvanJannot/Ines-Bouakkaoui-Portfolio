export default function ProjectSummaryCard({
  ...
  return (
    <article
      className="relative rounded-xl border border-black/30 bg-[#F6D0BB] shadow-[0_4px_0_#00000033] p-4 md:p-5 flex flex-col hover:cursor-pointer"
      onClick={onMoreInfo}
    >
      {/* vignette */}
      ...
      <div className="mt-auto flex items-center justify-end gap-2">
        <button
          onClick={onMoreInfo}
          className="px-5 py-1 rounded-full bg-[#004AAD] border border-black/30 hover:brightness-105 hover:bg-[#6183B2] transition text-white hover:cursor-pointer"
        >
          More info
        </button>
      </div>
